...
from director.views import ExpenditureView, FinanceView, HomePageView, LabelListView, SpareListView, StockView, \
    admin_pre_production_send_list, admin_sales, sales_history, MonitorPageView

app_name = 'director'

urlpatterns = [
    path('dashboard/', MonitorPageView.as_view(), name='dashboard'),
    path('dashboard/material/', HomePageView.as_view(), name='material'),
