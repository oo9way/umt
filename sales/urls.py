...
from sales.views import CreateProductStockView, StockBarcodeView, StockView, remove_local_storage, sales, sales_history, stock_sell
...
urlpatterns = [
    ...
    path("dashboard/stock/create/", CreateProductStockView.as_view(), name="stock-create"),
